...
template BootloaderInfoRequestID() {
    const char[] BootloaderInfoRequestID = "[ " ~ mixin(
        CommonMagic!()) ~ ", 0xf55038d8e2a1202f, 0x279426fcf5f59740 ]";
}
...
template StackSizeRequestID() {
    const char[] StackSizeRequestID = "[ " ~ mixin(
        CommonMagic!()) ~ ", 0x224ef0460a8e8926, 0xe1cb0fc25f46ea3d ]";
}
...
template PagingModeRequestID() {
    const char[] PagingModeRequestID = "[ " ~ mixin(
        CommonMagic!()) ~ ", 0x95c1a0edab0944cb, 0xa4e5cb3842f7488a ]";
}
...
template SMPRequestID() {
    const char[] SMPRequestID = "[ " ~ mixin(
        CommonMagic!()) ~ ", 0x95a67b819a1b857e, 0xa0b61b723b6a73e0 ]";
}
...
template EntryPointRequestID() {
    const char[] EntryPointRequestID = "[ " ~ mixin(
...
template RSDPRequestID() {
    const char[] RSDPRequestID = "[ " ~ mixin(
        CommonMagic!()) ~ ", 0xc5e77b6b397e7b43, 0x27637845accdcf3c ]";
}
...
template SMBIOSRequestID() {
    const char[] SMBIOSRequestID = "[ " ~ mixin(
        CommonMagic!()) ~ ", 0x9e9046f11e095391, 0xaa4a520fefbde5ee ]";
}
...
template EFISystemTableRequestID() {
    const char[] EFISystemTableRequestID = "[ " ~ mixin(
        CommonMagic!()) ~ ", 0x5ceba5163eaaf6d6, 0x0a6981610cf65fcc ]";
}
...
template BootTimeRequestID() {
    const char[] BootTimeRequestID = "[ " ~ mixin(
        CommonMagic!()) ~ ", 0x502746e184c088aa, 0xfbc5ec83e6327893 ]";
}
...
template DTBRequestID() {
    const char[] DTBRequestID = "[ " ~ mixin(
        CommonMagic!()) ~ ", 0xb40ddb48fb54bac7, 0x545081493f81ffb7 ]";
}
